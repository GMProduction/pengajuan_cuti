                            ...
                            <div class="col-8">
                                ...
                                <div class="form-floating mb-1">
                                    <input type="text" class="form-control" id="dk_namakaryawan"
                                        value="{{ $data->karyawan->nama }}" name="dk_namakaryawan" placeholder="Karyawan">
                                    <label for="dk_namakaryawan" class="form-label">Nama Karyawan</label>
                                </div>

                                <div class="form-floating mb-1">
                                    <textarea class="form-control" placeholder="Leave a comment here" id="dk_alamat"  style="height: 100px">{{ $data->karyawan->alamat }}</textarea>
                                    <label for="dk_alamat">Alamat</label>
                                </div>

                                <div class="form-floating mb-1">
                                    <input type="text" class="form-control" id="dk_username" name="dk_username"
                                ...
                                <div class="form-floating mb-5">
                                    <input type="text" class="form-control" id="dk_sisacuti" name="dk_sisacuti"
